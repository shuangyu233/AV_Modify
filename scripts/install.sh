...
currentVersion=''
latestVersion=''
downloadPrefix='https://github.com/shuangyu233/AV_Modify/releases/download/'
githubApi="https://api.github.com/repos/shuangyu233/AV_Modify/releases/latest"
manageScript="https://raw.githubusercontent.com/shuangyu233/AV_Modify/main/scripts/install.sh"
